    ...
    <div class="page-wrapper">
        <div class="container py-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2>Edit Customer</h2>
                <div>
                    <a href="${pageContext.request.contextPath}/admin/customers/view?id=${customer.userId}" class="btn btn-secondary me-2">
            ...
            <div class="row">
                <div class="col-md-10 col-lg-8 mx-auto">
                    ...
                    <div class="form-container">
                        <form action="${pageContext.request.contextPath}/admin/customers/edit" method="post" id="customerEditForm">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="isVerified" name="isVerified" ${customer.isVerified ? 'checked' : ''}>
