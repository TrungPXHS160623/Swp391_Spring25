...
public class BlogListController extends HttpServlet {
    ...
    throws ServletException, IOException {
        // Ví dụ: lấy danh sách blog (có thể bổ sung logic tìm kiếm, lọc nếu cần)
        List<PostDto> blogList = blogDao.getAllBlog();
        request.setAttribute("blogList", blogList);
        
        // Chuyển tiếp sang trang JSP hiển thị danh sách blog
